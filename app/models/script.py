...
Tables:
  ...
  indicator_cache    – optional caching of computed indicators
"""
...
class IndicatorCache(Base):
    ...
    values_json  = Column(JSON, nullable=False)       # list of floats
    bar_count    = Column(Integer, nullable=False)
    computed_at  = Column(DateTime(timezone=True), nullable=False, default=_now)
    expires_at   = Column(DateTime(timezone=True), nullable=True)

    __table_args__ = (
        Index("ix_indicator_cache_symbol_tf", "symbol", "timeframe"),
        Index("ix_indicator_cache_expires_at", "expires_at"),
    )
